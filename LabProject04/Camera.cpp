...
void CCamera::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	pd3dCommandList->SetGraphicsRootConstantBufferView(0, d3dGpuVirtualAddress); // Camera CBV를 루트 파라미터 0번에 바인딩
}
...
// CFirstPersonCamera, CThirdPersonCamera 구현부
...
CSpaceShipCamera::CSpaceShipCamera(CCamera* pCamera) : CCamera(pCamera) { m_nMode = SPACESHIP_CAMERA; }
