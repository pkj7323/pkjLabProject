	...
	, int nMeshes)
{
	...
	CGameObject::SetMesh(0, pAirplaneMesh);
	m_pCamera = CAirplanePlayer::ChangeCamera(SPACESHIP_CAMERA/*THIRD_PERSON_CAMERA*/, 0.0f);
	...
	ID3D12RootSignature* pd3dGraphicsRootSignature, void* pContext, int nMeshes)
{
	...
	CCubeMeshDiffused *pCubeMesh = new CCubeMeshDiffused(pd3dDevice, pd3dCommandList,
														 4.0f, 12.0f, 4.0f);
	CGameObject::SetMesh(0, pCubeMesh);
