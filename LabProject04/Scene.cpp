...
#endif
	HRESULT hr = D3DCompileFromFile(L"Shaders.hlsl", NULL, NULL, "VSMain", "vs_5_1", nCompileFlags, 0,
					   &pd3dVertexShaderBlob, NULL);

	DXCall(hr);

	hr = D3DCompileFromFile(L"Shaders.hlsl", NULL, NULL, "PSMain", "ps_5_1", nCompileFlags, 0,
